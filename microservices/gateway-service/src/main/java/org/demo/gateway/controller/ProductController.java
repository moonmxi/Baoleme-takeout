...
import org.demo.gateway.dto.request.product.ProductInfoRequest;
...
public class ProductController {
    ...
    public CommonResponse getProductInfoByRequest(@Valid @RequestBody ProductInfoRequest request) {
        try {
            ProductInfoResponse response = productService.getProductInfo(request.getId());
    ...
    public CommonResponse getProductReviews(@PathVariable Long productId,
        ...
        try {
            List<ProductReviewResponse> reviews = productService.getProductReviews(productId, page, pageSize);
    ...
    public CommonResponse getStoreProducts(@PathVariable Long storeId,
                                          ...
                                          @RequestParam(value = "page_size", defaultValue = "10") int pageSize) {
        try {
            Map<String, Object> products = productService.getStoreProducts(storeId, category, page, pageSize);
